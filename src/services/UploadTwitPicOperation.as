package services
{
	...
	public class UploadTwitPicOperation extends Operation
	{
		...
		public function UploadTwitPicOperation( image_data : BitmapData, extra_params : Object )
		{
			super();
		...
		override public function execute() : void
		{
			...
			urlRequest = new URLRequest( "http://api.twitpic.com/1/upload.json" );
